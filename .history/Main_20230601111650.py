...
# Plot the stock data and the support and resistance levels
plt.plot(df['Date'], df['Close'])
plt.plot(df['Date'], support_levels, '--', color='blue')
plt.plot(df['Date'], resistance_levels, '--', color='red')
