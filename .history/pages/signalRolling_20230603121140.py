...
close = df['Close']
ax = sns.lineplot(data=close, color='r', lw=2.)
ax.plot(close, '^', markersize=10, color='m', label='buying signal', markevery=states_buy)
ax.plot(close, 'v', markersize=10, color='k', label='selling signal', markevery=states_sell)
