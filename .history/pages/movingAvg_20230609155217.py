...
plt.plot(close, 'v', markersize=10, color='m', label = 'selling signal', markevery = states_buy)
plt.plot(close, '^', markersize=10, color='k', label = 'buying signal', markevery = states_sell)
